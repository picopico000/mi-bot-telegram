...
def download_file(update: Update, context: CallbackContext):
    # Ruta del archivo que quieres permitir descargar
    file_path = "DAtasss.xlsx"  # Cambia a la ruta del archivo deseado
    if os.path.exists(file_path):
        update.message.reply_text("Preparando el archivo para descarga...")
        ...
        update.message.reply_text("El archivo no se encontró. Asegúrate de que existe en el servidor.")
